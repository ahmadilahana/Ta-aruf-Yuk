...
?>
        ...
        <ul class="nav justify-content-center menu">
            <li class="nav-item">
                <a class="nav-link <?= $retVal = ($akun == 'lihatprofile-lain') ? 'aktif active' : ' '; ?>" href="?page=lihatprofile-lain&menu=lain&id=<?= $id ?>">Profile</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?= $retVal = ($akun == 'foto-lain') ? 'aktif active' : ' '; ?>" href="?page=foto-lain&menu=lain&id=<?= $id ?>">Foto</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?= $retVal = ($akun == 'pendidikan-lain') ? 'aktif active' : ' '; ?>" href="?page=pendidikan-lain&menu=lain&id=<?= $id ?>">Pendidikan</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?= $retVal = ($akun == 'pekerjaan-lain') ? 'aktif active' : ' '; ?>" href="?page=pekerjaan-lain&menu=lain&id=<?= $id ?>">Pekerjaan</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?= $retVal = ($akun == 'minat-lain') ? 'aktif active' : ' '; ?>" href="?page=minat-lain&menu=lain&id=<?= $id ?>">Minat dan Kepribadian</a>
            </li>
        </ul>
